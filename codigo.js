...
formAgregarProducto.addEventListener("submit", async (evento) => {
    ...
    try {
        ...
        mostrarError("Producto agregado exitosamente.");
    } catch (error) {
...
async function eliminarProducto(id) {
    ...
    console.log(`Intentando eliminar el producto con ID: ${id}`); // Agregado para depuración
    ...
    try {
        ...
        console.log(`Respuesta de DELETE: `, respuesta); // Agregado para depuración
...
function mostrarListadoYAgregar() {
    listado.style.display = "block";
    agregarProductoSection.style.display = "block";
}
